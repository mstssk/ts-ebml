                ...
                tests = [
                    {
                        index: 0,
                        test: function (elm) {
                            assert.ok(elm.name === "EBML" && elm.type === "m" && elm.isEnd === false);
                        },
                    },
                    {
                        index: 4,
                        test: function (elm) {
                            assert.ok(elm.name === "EBML" && elm.type === "m" && elm.isEnd === true);
                        },
                    },
                    {
                        index: 5,
                        test: function (elm) {
                            assert.ok(elm.name === "Segment" && elm.type === "m" && elm.isEnd === false);
                        },
                    },
                    {
                        index: 24,
                        test: function (elm) {
                            assert.ok(elm.name === "Info" && elm.type === "m" && elm.isEnd === false);
                        },
                    },
                    {
                        index: 25,
                        ...
                        test: function (elm) {
                            ...
                            assert.ok(elm.type === "d" &&
                                _1.tools.convertEBMLDateToJSDate(elm.value).getTime() ===
                                    new Date("2010-08-21T07:23:03.000Z").getTime()); // toISOString
                        },
                    },
                    {
                        index: 29,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    refinedWebM = new Blob([refinedMetadataBuf, body], {
                        type: "video/webm",
                    });
                    _a.label = 3;
                case 3:
